...
<p style="padding: 25px 0px 10px; position: relative;" ><h2>辅导员登录</h2></p>
        ...
        <DIV
            ...
            <span  id="tiaozhuan"
                style="display:block; float: left;margin-left: 10px;"><a href="../teacher/login_teacher.jsp"><strong>点此进入教师登录页面</strong></a></span>
        ...
        <span style="margin-left:-380px"><a href="../manager/login_manager.jsp"><strong>点此进入管理员登录页面</strong></a></span>
	...
	$("#loginBtn").click(
			function() {
				...
				var loginInfo = "guideId=" + v1 + "&password=" + v2;
				if (v1 == "" || v2 == "") {
					showMessage(3);
				}else {
					$.ajax({
						type : "post",
						url : "guide_login.action",
						data : loginInfo,
						async : false,
						success : function(result) {
							...
							if (data.name == "login"
								...
								window.location.href = "index_guide.jsp";
							} else {
								showMessage(0);
							}
						},
