...
<script type="text/javascript">
	...
	function checkAction(n){
		if(n == 0){
			document.formName.action="manager_checkCoursePass";
			dbform.submit();
		}
	}
</script>
				...
				<section class="panel">
					<header class="panel-heading">
						<i class="fa fa-hand-o-down"> </i> <span
							class="label label-primary" style="font-size:medium"> 完善课程信息
						</span>
					</header>
								...
								<div class="modal-content">
									...
									<div class="modal-body" style="padding: 100px 100px 10px;">
										...
										<div width="100px" height="20px">
											<label for="name" style="font-size: medium">
												课程代码&nbsp;:&nbsp;&nbsp;&nbsp;</label> 
												<input name="courseNo" value="${course.getcNo() }" readonly="readonly" type="text" style="width:200px;">
										</div>
										<div>
										<label for="name" style="font-size: medium" > 任课教师:&nbsp; </label>
										 <input
												name="teacherName" value="${course.getTeachers().gettName() }" readonly="readonly" type="text"  style="width:200px;">
										</div>
										<div>
										<label for="name" style="font-size: medium" > 上课时间:&nbsp; </label>
										 <input
												name="schoolTime" value="" placeholder="1-16周7-8节;4-9周3-4节"  type="text"  style="width:200px;">
										</div>
										<div>
										<label for="name" style="font-size: medium" > 考试周:&nbsp; </label>
										 <input
												name="examTime" value="0"  type="text"  style="width:200px;">
												<input
												name="courseId" value="${course.getcId() }"  type="text"  style="width:200px;display: none;">
										</div>
