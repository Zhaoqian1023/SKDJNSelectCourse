...
<p style="padding: 25px 0px 10px; position: relative;" ><h2>教务管理员登录</h2></p>
        <P style="padding: 20px 0px 10px; position: relative;">
            <SPAN class="u_logo"></SPAN> <INPUT class="ipt" id="uname"
                name="uname" type="text" value=""  placeholder="请输入教务管理员账号">
        ...
        <span style="margin-left:-380px"><a href="../guide/login_guide.jsp"><strong>点此进入辅导员登录页面</strong></a></span>
	...
	$("#loginBtn").click(
			function() {
				...
				var loginInfo = "managerId=" + v1 + "&password=" + v2;
				if (v1 == "" || v2 == "") {
					showMessage(3);
				}else {
					$.ajax({
