			...
			<section class="wrapper">
				...
				<section class="panel">
					...
					<div class="panel-body">
						<form method="post" action="manager_addTeacher">
							...
							<div class="modal-content">
								...
								<div class="modal-body" style="padding: 100px 100px 10px;">
										<div width="100px" height="20px">
											...
											</label> <input name="teacherId" readonly="readonly"   type="text" >
										</div>
										<div width="100px" height="20px">
											<label for="name" style="font-size: medium"> 教师姓名&nbsp;:&nbsp;&nbsp;
											</label> <input name="teacherName"   type="text">
										</div>
										<div width="100px" height="20px">
										...
										<div width="100px" height="20px">
											<label for="name" style="font-size: medium"> 所属院系&nbsp;:&nbsp;&nbsp;
											</label> <!--  <input name="dname"  type="text">-->
											<select
												name="dept" style="width:155px">
												<option value="">无</option>
