			...
			<section class="wrapper">
				...
				<section class="panel">
					...
					<div class="panel-body">
						<form method="post" action="manager_updateTeacher">
									...
									<div class="modal-body" style="padding: 100px 100px 10px;">
										<div width="100px" height="20px">
											<label for="name" style="font-size: medium"> 教师工号&nbsp;: &nbsp;</label> <input
												name="teacherId" value="${teacherResult.gettId()}" type="text"
												readonly="readonly">
										</div>
										<div width="100px" height="20px">
											<label for="name" style="font-size: medium"> 教师姓名&nbsp;: &nbsp;</label> <input
												name="teacherName" value="${teacherResult.gettName()}" type="text">
										</div>
										<div width="100px" height="20px">
											<label for="name" style="font-size: medium"> 所属教研室: </label>
												<select name="position">
												<option value="${teacherResult.getPosition() }">${teacherResult.getPosition() }</option>
										...
										<div width="100px" height="20px">
											<label for="name" style="font-size: medium"> 职&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称&nbsp;:&nbsp; </label>
											<select name="title" style="width:155px">
												<option value="${teacherResult.getTitle() }">${teacherResult.getTitle() }</option>
										...
										<div width="100px" height="20px">
											...
											-->
											<select name="dept" style="width:155px">
												<option value="${teacherResult.getDept() }">${teacherResult.getDept()}</option>
										...
										<div width="100px" height="20px">
											<label for="name" style="font-size: medium"> 权&nbsp;限:&nbsp;&nbsp;
											</label> <!--  <input name="dname"  type="text">-->
											<select
												name="rank" style="width:155px">
												<c:if test="${teacherResult.getRank() ==2 }"><option value="2">教师</option></c:if>
												<c:if test="${teacherResult.getRank() ==1 }"><option value="1">辅导员</option></c:if>
												<c:if test="${teacherResult.getRank() ==0 }"><option value="0">管理员</option></c:if>
