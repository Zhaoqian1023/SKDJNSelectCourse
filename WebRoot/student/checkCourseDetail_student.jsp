																	...
																	<table class="LUpLines" width="100%" cellspacing="0"
																		...
																		<tbody>
																			...
																			<tr class="Font8Pt" valign="middle" align="center">
																				...
																				<textarea name="details" style="width:280px;" rows="6" >
																					${course.getDetails() }
																				</textarea>
																			...
																			<table>selectFlag 
																				<tr style="border: 0px">
																				    <td>
																				    <form name="selectCourse" action="student_selectCourse" method="post">
																				        <c:choose>
																				        	<c:when test="${selectFlag == 1 }">
																				        		<input type="text" style="display: none;" name="courseId" value="${course.getcId() }" >
