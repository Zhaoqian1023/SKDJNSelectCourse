...
<p style="padding: 25px 0px 10px; position: relative;" ><h2>学生登录</h2></p>
        <P style="padding: 20px 0px 10px; position: relative;">
            <SPAN class="u_logo"></SPAN> <INPUT class="ipt" id="uname"
                name="uname" type="text" value=""  placeholder="请输入学号">
        ...
        <DIV
            ...
            <span id="errorMessage"
                ...
                <span
                style="margin-top:-5px"> <input id="loginBtn" type="submit"
                value="登录"
	...
	$("#loginBtn").click(
			function() {
				...
				var loginInfo = "studentId=" + uid + "&password=" + passWord;
				if (uid == "" || passWord == "" || uid.length != 12) {
					showMessage(3);
				}else {
					$.ajax({
						type : "post",
