...
<p style="padding: 25px 0px 10px; position: relative;" ><h2>教师登录</h2></p>
        ...
        <span style="margin-left:-390px"><a href="../guide/login_guide.jsp"><strong>点此进入辅导员登录页面</strong></a></span>
	...
	$("#loginBtn").click(
			function() {
				...
				var loginInfo = "teacherId=" + v1 + "&password=" + v2;
				if (v1 == "" || v2 == "") {
					showMessage(3);
				}else {
					$.ajax({
						type : "post",
						url : "teacher_login.action",
						data : loginInfo,
						async : false,
