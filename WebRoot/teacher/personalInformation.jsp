																...
																<table class="LUpLines" width="100%" cellspacing="0"
																	...
																	<tbody>
																		<tr class="Font8Pt" valign="top"  align="center">
																			...
																			<td  class="RULine" ><center><input type="text"size="12" name="teacherID" readonly="readonly" style="border: 0px" value="${teacher.gettId() }"></center></td>
																			
																		</tr>
																		
																		<tr class="Font8Pt" valign="top" align="center" >
																			<td class="RULine" nowrap="nowrap">姓名:</td>
																			<td  class="RULine" ><center><input type="text"size="12" name="teacherName" readonly="readonly" style="border: 0px" value="${teacher.gettName() }"></center></td>
																		</tr>
																		<tr class="Font8Pt" valign="top" align="center" >
																			<td class="RULine" nowrap="nowrap">教研室：</td>
																			<td  class="RULine" ><center><input type="text"size="12" name="teacherName" readonly="readonly" style="border: 0px" value="${teacher.getPosition() }"></center></td>
																		</tr>
																		<tr class="Font8Pt" valign="top" align="center" >
																			<td class="RULine" nowrap="nowrap">职称:</td>
																			<td  class="RULine" ><center><input type="text"size="12" name="teacherdept" readonly="readonly" style="border: 0px" value="${teacher.getTitle() }"></center></td>
																		</tr>
																		<tr class="Font8Pt" valign="top" align="center" >
																			<td class="RULine" nowrap="nowrap">所在院系:</td>
																			<td  class="RULine" ><center><input type="text"size="12" name="teacherdept" readonly="readonly" style="border: 0px" value="${teacher.getDept() }"></center></td>
																		</tr>
																		<table>
																		<tr style="border: 0px">
																		<td><br><br>&nbsp</td>
